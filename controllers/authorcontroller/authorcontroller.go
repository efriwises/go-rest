...
func Index(w http.ResponseWriter, r *http.Request) {
	...
	//awalnya gini, tapi pindah ke response
...
func Detail(w http.ResponseWriter, r *http.Request) {
	idParams := mux.Vars(r)["id"] // id ini sesuai dengan param yg di routes
	id, _ := strconv.Atoi(idParams) //convert string jadi integer
